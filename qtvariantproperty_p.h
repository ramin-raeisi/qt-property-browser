...
class QTPROPERTYBROWSER_API QtVariantProperty : public QtProperty
{
public:
...
class QTPROPERTYBROWSER_API QtVariantPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class QTPROPERTYBROWSER_API QtVariantEditorFactory : public QtAbstractEditorFactory<QtVariantPropertyManager>
{
    Q_OBJECT
public:

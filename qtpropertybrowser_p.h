...
class QTPROPERTYBROWSER_API QtProperty
{
public:
    virtual ~QtProperty();
...
class QTPROPERTYBROWSER_API QtAbstractPropertyManager : public QObject
{
    Q_OBJECT
public:
...
class QTPROPERTYBROWSER_API QtAbstractEditorFactoryBase : public QObject
{
    Q_OBJECT
public:
...
class QTPROPERTYBROWSER_API QtBrowserItem
{
public:
...
class QTPROPERTYBROWSER_API QtAbstractPropertyBrowser : public QWidget
{
    Q_OBJECT
public:
